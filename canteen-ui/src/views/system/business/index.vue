...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="businessList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="店铺位置" align="center" prop="shopSeat" />
      <el-table-column label="店铺图片" align="center" prop="shopImage" width="100">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="85px">
        ...
        <el-form-item label="店铺位置" prop="shopSeat">
          <el-input v-model="form.shopSeat" placeholder="请输入店铺位置" />
        </el-form-item>
