...
<!--      <el-table-column label="留言id" align="center" prop="msgId" />-->
      <el-table-column label="商家名称" align="center" prop="businessName" />
      <el-table-column label="用户名称" align="center" prop="userName" />
      <el-table-column label="留言信息" align="center" prop="message" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除留言编号为"' + msgIds + '"的数据项？').then(function() {
