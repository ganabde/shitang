...
<!--          </el-col>-->
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户类别" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="用户类别" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" placeholder="请选择用户类别" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.userId != undefined) {
            ...
            if (this.form.deptId === 105){
              this.form.roleIds = [100]
            }else if (this.form.deptId === 205){
